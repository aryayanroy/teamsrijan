...
<body class="d-flex flex-column min-vh-100">
                ...
                <div id="header-collapse" class="collapse navbar-collapse flex-grow-0">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a href="overview" class="dropdown-item active">Overview</a></li>
    ...
    <main class="flex-grow-1 bg-body-tertiary">
        <article class="container-xxl">
            <section class="hero-image position-relative" style="background-image: url(uploads/images/davide-ragusa-gcDwzUGuUoI-unsplash.jpg)">
                <h1 class="mb-0 position-absolute top-50 start-50 translate-middle">Who Are We?</h1>
            </section>
            <hr>
            <section>
                <p class="text-center">Team Srijan is one of the oldest technical clubs of Birla Institute Of Technology, MESRA, Ranchi, which has been growing steadily since 2007. It is a group of undergraduate students from various branches of engineering who work together to design, conceive and manufacture the prototype of a formula race car to participate in Formula Student competitions held across the globe.</p>
            </section>
            <hr>
            <section class="row gy-3">
                <div class="col-sm-6 col-md-5 col-lg-4">
                    <div class="ratio ratio-4x3"><img src="uploads/images/aman-pal-XXeT1yiSx0g-unsplash.jpg" alt="Race" class="w-100 object-fit-cover"></div>
                </div>
            ...
            <section class="row gy-3 flex-row-reverse">
                <div class="col-sm-6 col-md-5 col-lg-4">
                    <div class="ratio ratio-4x3"><img src="uploads/images/jesper-giortz-behrens-yn8-sVBtys8-unsplash.jpg" alt="Race" class="w-100 object-fit-cover"></div>
                </div>
                <div class="col-sm-6 col-md-7 col-lg-8">
                    <h3>2007</h3>
                    <p>With the planning and budgeting done, the cost of building the vehicle will be a whopping Rs 27lakhs, out of which the college is contributing 6L and the students have managed to get sponsorship commitment of another 6L. As BITOSA Global, we want to support Team Srijan in this initiative and have committed to raise at least 6L for them to match what the college has contributed. This will give them the required runway so that they can go ahead and raise the remaining 9L through other sponsorships.</p>
            ...
            <section class="row gy-3">
                <div class="col-sm-6 col-md-5 col-lg-4">
                    <div class="ratio ratio-4x3"><img src="uploads/images/toine-g-XP-J5O6A4Ko-unsplash.jpg" alt="Race" class="w-100 object-fit-cover"></div>
                </div>
                <div class="col-sm-6 col-md-7 col-lg-8">
                    <h3>2009</h3>
                    <p>With the planning and budgeting done, the cost of building the vehicle will be a whopping Rs 27lakhs, out of which the college is contributing 6L and the students have managed to get sponsorship commitment of another 6L. As BITOSA Global, we want to support Team Srijan in this initiative and have committed to raise at least 6L for them to match what the college has contributed. This will give them the required runway so that they can go ahead and raise the remaining 9L through other sponsorships.</p>
