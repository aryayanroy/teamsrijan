                ...
                <div id="header-collapse" class="collapse navbar-collapse flex-grow-0">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link active dropdown-toggle" data-bs-toggle="dropdown">Partners</a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a href="sponsors" class="dropdown-item">Sponsors</a></li>
                                <li><a href="crowdfunding" class="dropdown-item active">Crowdfunding</a></li>
                            </ul>
                        </li>
    ...
    <main class="flex-grow-1 bg-body-tertiary">
        <article class="container-xxl">
            <section class="hero-image position-relative" style="background-image: url(uploads/images/davide-ragusa-gcDwzUGuUoI-unsplash.jpg)">
                <h1 class="mb-0 position-absolute top-50 start-50 translate-middle">Crowdfunding</h1>
            </section>
            <hr>
            <section>
                <h2>Rev the Inovation of Student Formula Racing!</h2>
                <p>Join our Crowdfunding Campaign and help us take Student Formula Racing to new heights!</p>
            </section>
            <hr>
        </article>
    </main>
