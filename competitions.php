...
<head>
    ...
    <title>Competitions | Team Srijan - Birla Institute of Technology, Mesra</title>
...
<body class="d-flex flex-column min-vh-100">
            ...
            <div class="container-xl">
                ...
                <div id="header-collapse" class="collapse navbar-collapse flex-grow-0">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="competitions" class="nav-link active">Competitions</a></li>
    ...
    <main class="flex-grow-1 bg-body-tertiary">
        <article class="container-xxl">
            <section class="hero-image position-relative" style="background-image: url(uploads/images/aman-pal-XXeT1yiSx0g-unsplash.jpg)">
